...
namespace OS1 {
const size_t IMU_PACKET_SIZE = 48;

const int LIDAR_V_RES = 64;
const int LIDAR_COL_PER_PACKET = 16;
const size_t LIDAR_COL_SIZE = 788;
const size_t LIDAR_PACKET_SIZE = LIDAR_COL_SIZE * LIDAR_COL_PER_PACKET;
const size_t LIDAR_DBLOCK_SIZE = 12;
